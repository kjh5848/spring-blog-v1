...
insert into reply_tb(user_id, board_id, comment, username, created_at)
values (1, 1, '하이', 'ssar', now());
insert into reply_tb(user_id, board_id, comment, username, created_at)
values (2, 1, '노우', 'ssar', now());
insert into reply_tb(user_id, board_id, comment, username, created_at)
values (1, 2, '바이', 'cos', now());
insert into reply_tb(user_id, board_id, comment, username, created_at)
values (1, 4, '바이', 'cos', now());

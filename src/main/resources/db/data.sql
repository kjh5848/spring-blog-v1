insert into user_tb(username, password, email, created_at) values('ssar', '$2a$10$yRWcVKD4P5XddV5u2rbZO.m9eDrEF/YVvMPKDZpBtwVHTKoP7YJRq', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at) values('cos', '$2a$10$yRWcVKD4P5XddV5u2rbZO.m9eDrEF/YVvMPKDZpBtwVHTKoP7YJRq', 'cos@nate.com', now());
